    ...
    def create_nodes(self, count, test_agent, port, cloud=None, inst_type=None):
        ...
        while len(ready) < count:
            ...
            try:
                ...
                #name = "%s-u%s-s%s-%s-%s" % (self.__conpaas_name, self.__conpaas_user_id, self.__conpaas_service_id, service_type, role_abbr)
                name = "%s-%s-%s-u%s-s%s" % (self.__conpaas_name, role_abbr, service_type, self.__conpaas_user_id, self.__conpaas_service_id)
