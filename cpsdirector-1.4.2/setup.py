...
setup(name='cpsdirector',
      ...
      download_url='http://www.conpaas.eu/dl/',
      license='BSD',
      ...
      dependency_links=[ 'https://github.com/ftfniqpl/conpaas1.4/blob/master/cpslib-%s.tar.gz?raw=true' % CPSVERSION, 'https://pypi.python.org/packages/source/n/netaddr/netaddr-0.7.13.tar.gz'],)
